...
import alugueluguebrasilnovo.alugueluguebrasil.Usuario.AluguePerfilUsuario;
...
import alugueluguebrasilnovo.alugueluguebrasil.objetosUsados.MessageAdapter;
import alugueluguebrasilnovo.alugueluguebrasil.objetosUsados.Messages;
import de.hdodenhof.circleimageview.CircleImageView;

public class AlugueChatAnuncio extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_alugue_chat_anuncio);
        final ActionBar act = getSupportActionBar();
        act.hide();
        DatabaseUtil.getDatabase();
        mDatabaseUsuario = FirebaseDatabase.getInstance().getReference();
        ...
        mDatabaseUsuario.child("usuario").child(mUsuario).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
               ...
               final String key = dataSnapshot.getKey();
                ...
                Picasso.with(AlugueChatAnuncio.this).load(imgChat).placeholder(R.drawable.default_avatar).into(ImagemChat);

                ImagemChat.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {

                        Intent perfil = new Intent(AlugueChatAnuncio.this, AluguePerfilUsuario.class);
                ...
                mEuUsuario.child("usuario").child(euUsuario).addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        final String EuNome = dataSnapshot.child("nome").getValue().toString();
                        final String EuImg = dataSnapshot.child("imagem").getValue().toString();
        ...
        voltarTela.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent voltar = new Intent(AlugueChatAnuncio.this, AlugueListaConversa.class);
    ...
    public void onBackPressed() {
        startActivity(new Intent(AlugueChatAnuncio.this, MainActivity.class));
        finish();
